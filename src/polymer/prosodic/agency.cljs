...
;; It does not own TTS, LipSync, React, storage, or the animation runtime. The
;; character network routes TTS/Blink facts here, then routes Prosodic's
;; animation requests to Polymer Animation.
